...
<!-- Mirrored from thewebmax.org/industro/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Aug 2023 17:02:46 GMT -->
...
<body class="footer-fixed">
    ...
    <div class="page-wraper">
        ...
        <div class="page-content">
            ...
            @extends('layouts.shop.getintouch')
            @extends('layouts.shop.about')
            @extends('layouts.shop.top_header')
