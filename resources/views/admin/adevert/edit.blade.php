...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Ads </h1>
            ...
            <div class="container-fluid">
                <!-- Page Heading -->
                <div class="col-auto">
                    <form method="POST" action="{{ route('admin.adevert.update', $adevert->id) }}" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        @method('PUT')
                        <fieldset>
                            <!-- Text input-->
                            ...
                            <div class="col-md-4">
                                <input id="filebutton" name="ads_image" value="{{$adevert['ads_image']}}" class="input-file" type="file">
                                {{$adevert['ads_image']}}
                            </div>
                            </div>
                            ...
                            <input id="title" name="title" placeholder="Title"
                                class="form-control input-md" required type="text" value="{{$adevert['title']}}">
                            <input type="color" name="title_color" value="{{$adevert['title_color']}}">     
                            </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <select id="product_catagories" name="catagory" class="form-control">
                                    <option value="{{$adevert['catagory']}}" required>Catagories</option>  
                            ...
                            <input id="product_price" name="subject" placeholder="Subject"
                                class="form-control input-md" required type="text" value="{{$adevert['subject']}}">
                            <input type="color" name="subject_color" value="{{$adevert['subject_color']}}">    
                            </div>
                            </div>
                            ...
                            <div class="col-md-4">
                            <textarea name="promoted_des">{{$adevert['promoted_des']}}</textarea>
