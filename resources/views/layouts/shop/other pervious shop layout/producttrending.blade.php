                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="banner-text text-center pt-50 pb-45">
                            <h2 class="f-800 cod__black-color">Product Trending</h2>
                    ...
                    <div class="col-sm-9 col-8">
                        <div class="shop-cat">
                            <div class="show-text d-none d-sm-block">
                                <span class="f-400"> {{ $count_trending }} results</span>
                            </div>
                    ...
                    @foreach ($products as $product)
                        <div class="col-lg-4 col-md-6">
                            <div class="product__single mb-30">
                                <div class="product__box featured__box--item" id="product-data">
                                    <div class="product__thumb">
                                        <a href="{{ route('product_details') }}?pro={{ $product->id }}">
                                            <img class="img"
                                    ...
                                    <div class="product--flex__right">
                                        <div class="product__content--top">
                                            <span class="cate-name">{{ $product->product_catagories }}</span>
                                        ...
                                        <div class="product__content--rating d-flex justify-content-between">
                                            ...
                                            <div class="price">
                                                ...
                                                <p class="grenadier-color f-600">
                                                    {{ $setting->currency }}<b>{{ number_format($product->product_logical_price, 2) }}</b>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
