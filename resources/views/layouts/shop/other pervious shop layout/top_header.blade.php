                            ...
                            <nav class="nav--top__list">
                                <ul class="list-inline">
                                    ...
                                    <li class="nav--top__dropdown position-relative"><a
                                            ...
                                            href="#">English<span class="lnr lnr-chevron-down"></span></a>
                    ...
                    <div class="col-sm-12">
                        <div class="content--header__middle d-flex align-items-center justify-content-between">
                            ...
                            <div class="search--header__middle h1search--header__middle">
                                <form class="search--header__form position-relative" method="GET"
                                    action="{{ route('FilterCatagories') }}?search=search">
                                    @csrf
                                    ...
                                    <!-- Search Results List -->
                                    <div class="search_view" style="display: block">
                        ...
                        <div class="dept__menu position-relative d-none d-md-block">
                            <nav>
                                <ul class="dept__menu--list">
                                    <li><a class="dept__menu-mlink f-900 cod__gray-color" href="JavaScript:Void(0);">Shop
                                            By Departments</a>


                                        <ul class="dept__menu--dropdown open shadow-sm rounded">
                                            {{-- <li><a class="dept__menu--dlink" href="#">Showpiece & Wall Art</a></li> --}}
                                            @foreach ($catagories as $catagory)
                                                <li class="dropdown"><a class="dept__menu--dlink"
                                                        href="{{ route('FilterCatagories') }}?cata={{ $catagory->catagory_name }}">{{ $catagory->catagory_name }}</a>
                                                    <ul class="sub__menu sub__dept--menu shadow-sm rounded">

                                                        <li><a
                                                                href="{{ route('FilterCatagories') }}?cata={{ $catagory->parent->catagory_name }}">{{ $catagory->parent->catagory_name }}</a>
                                                        </li>
                        ...
                        <div class="main-menu">
                            <nav id="mobile-menu">
                                <ul>
                                    ...
                                    <li>
                                        <a rel="canonical" href="{{ route('about') }}">About Us</a>
                                    </li>
                                    <li>
                                        <a rel="canonical" href="{{ route('product_trending') }}">Trending</a>
                                    </li>
                                    @foreach ($selected_menu as $menu)
                                        <li>
                                            <a rel="canonical"
                                                href="{{ route('FilterCatagories') }}?cata={{ $menu['catagory_name'] }}">{{ $menu['catagory_name'] }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </nav>
